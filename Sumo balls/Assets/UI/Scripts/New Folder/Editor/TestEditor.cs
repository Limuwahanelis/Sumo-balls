...
[CustomEditor(typeof(UIToolkitRebind))]
public class TestEditor : Editor
{
    UIToolkitRebind m_RebindActionUI;
    protected void OnEnable()
    {
        m_RebindActionUI = (UIToolkitRebind)target;

        m_ActionProperty = serializedObject.FindProperty("m_Action");
        m_BindingIdProperty = serializedObject.FindProperty("m_BindingId");
        m_BindingUIDocument = serializedObject.FindProperty("uiDocument");
        ...
        if (m_BindingUIDocument != null)
        {
            but = (m_BindingUIDocument.objectReferenceValue as UIDocument).rootVisualElement.Query<Button>().First();
            label = (m_BindingUIDocument.objectReferenceValue as UIDocument).rootVisualElement.Q<Label>("input-label");
            label.BindProperty(m_ActionOverrideStringProperty);
        }
    ...
    public override void OnInspectorGUI()
    {
        ...
        //m_ActionOverrideStringProperty.bin


        EditorGUILayout.LabelField(m_BindingLabel, Styles.boldLabel);
        using (new EditorGUI.IndentLevelScope())
        {
            EditorGUILayout.PropertyField(m_BindingUIDocument);
    ...
    private SerializedProperty m_BindingUIDocument;
